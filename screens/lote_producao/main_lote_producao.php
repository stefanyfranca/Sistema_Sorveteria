...
<a href="/SISTEMA_SORVETERIA/login.php"><i class="fa-solid fa-arrow-right-from-bracket"></i><p class="logout">Log Out</p></a>
    ...
    <div class="container">
        <div class="row">
            ...
            <h2>PRODUÇÃO </h2><br>
            <form action="main_lote_producao.php" method="POST">
            ...
            <table border="1px" bordercolor="gray" class="table table-stripped">
                ...
                if ((isset($_POST['pesquisar'])) or isset($_POST['cadastrar']))
                {
                    ...
                    <tr>
                        ...
                        <td>
							<?php 
								echo "<a href='excluir_producao.php?id_lote_producao=".$dados['id_lote_producao']."'><button class='btn btn-danger' type='button' name='excluir'>Excluir</button></a>";
							?>
